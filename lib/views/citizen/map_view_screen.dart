...
class _MapViewScreenState extends State<MapViewScreen>
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(top: 16, right: 16, child: _buildLegendCard()),
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildFloatingButton(Icons.refresh, () => _refreshIssues()),
              ],
            ),
          ),
          ...
          Marker(
            ...
            onTap: () {
              ...
              _mapController?.animateCamera(
                CameraUpdate.newLatLng(LatLng(issue.latitude, issue.longitude)),
              );
            },
            infoWindow: InfoWindow(title: issue.title, snippet: issue.status),
          ),
        );
      }
  ...
  Future<void> _hideIssuePreview() async {
